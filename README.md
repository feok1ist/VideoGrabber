...
* **[FFmepg](https://ffmpeg.org/download.html)** - конвертация аудио.
* **[Deno](https://deno.com/)** - JS-движок для yt-dlp.
* **[uv](https://docs.astral.sh/uv/)** - пакетный менеджер Python.
...
*   В VideoGrabber нет обхода блокировок. Используйте VPN или на сайте в разделе «Advanced»  введите прокси (поддерживаются http, https, socks5, socks4)
